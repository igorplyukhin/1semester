...
namespace Manipulation
{
    public static class AnglesToCoordinatesTask
    {
        ...
        {
            var elbowPos = CalcCoordinates(elbow, Manipulator.UpperArm);
            var wristPos = CalcCoordinates(elbow + shoulder + 180, Manipulator.Forearm);
            var palmEndPos = CalcCoordinates(elbow + shoulder + wrist, Manipulator.Palm);
            return new PointF[]
            {
                elbowPos,
                wristPos,
        ...
        private static PointF CalcCoordinates(double angle, double length)
        {
